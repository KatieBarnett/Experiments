...
//    alias(libs.plugins.ksp)id 'kotlinx-serialization'
}

android {
    namespace = "dev.katiebarnett.experiments.jcscrollstate"
    compileSdk = rootProject.extra["compileSdk"] as Int

    defaultConfig {
        applicationId = "dev.katiebarnett.experiments.jcscrollstate"
