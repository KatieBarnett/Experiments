package dev.katiebarnett.experiments.jclottie
        ...
        setContent {
            ExperimentsTheme {
                Scaffold(
                    ...
                    topBar = {
                        LargeTopAppBar(
                            title = { Text(text = "Lottie Animations Demo") },
                    ...
                    LazyVerticalGrid(
                        ...
                        modifier = Modifier
                            .padding(innerPadding).fillMaxSize().padding(top = 8.dp)
                    ) {
                        item {
                            LottieStringSource()
                        }
                        item {
                            LottieJsonFileAssetsSource()
                        }
                        item {
                            LottieLottieFileAssetsSource()
                        }
                        item {
                            LottieJsonFileRawSource()
                        }
                        item {
                            LottieUrlSource()
                        }
                        item {
                            LottieUrlSourceWithRetry()
                        }
                        item {
                            LottieUrlSourceWithRetryButton()
                        }
                        item {
                            LottieStringSourceRepeating()
                        }
                    }
                }
            }
...
@Composable
fun LottieStringSource(modifier: Modifier = Modifier) {
...
@Composable
fun LottieJsonFileRawSource(modifier: Modifier = Modifier) {
...
@Composable
fun LottieJsonFileAssetsSource(modifier: Modifier = Modifier) {
    val lottieCompositionSpec = LottieCompositionSpec.Asset("animations/android_wave.json")
    val lottieComposition = rememberLottieComposition(
        spec = lottieCompositionSpec
    )
    Column(
...
@Composable
fun LottieLottieFileAssetsSource(modifier: Modifier = Modifier) {
    val lottieCompositionSpec = LottieCompositionSpec.Asset("animations/android_wave.lottie")
    val lottieComposition = rememberLottieComposition(
        spec = lottieCompositionSpec
    )
    Column(
...
@Composable
fun LottieUrlSource(modifier: Modifier = Modifier) {
    val lottieCompositionSpec = LottieCompositionSpec.Url("https://katiebarnett.dev/assets/AndroidWave.json")
    val lottieComposition = rememberLottieComposition(
        spec = lottieCompositionSpec,
...
@Composable
fun LottieUrlSourceWithRetry(modifier: Modifier = Modifier) {
    ...
    LaunchedEffect(retryCount) {
        if (retryCount == 3) {
            url = "https://katiebarnett.dev/assets/AndroidWave.json"
        }
    }
    Column(
        modifier = modifier,
...
@Composable
fun LottieUrlSourceWithRetryButton(modifier: Modifier = Modifier) {
...
@Composable
fun LottieStringSourceRepeating(modifier: Modifier = Modifier) {
    val lottieCompositionSpec = LottieCompositionSpec.JsonString(JSON_STRING)
    val lottieComposition = rememberLottieComposition(
        spec = lottieCompositionSpec
    )
